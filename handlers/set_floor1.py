...
async def set_floor1_callback(callback_query: CallbackQuery):
    ...
    if action == '1Body':
        ...
        buttons = [
            InlineKeyboardButton("1 этаж", callback_data='1Floorr'),
            InlineKeyboardButton("4 этаж", callback_data='4Floorr'),
            InlineKeyboardButton("5 этаж", callback_data='5Floorr'),
            InlineKeyboardButton("6 этаж", callback_data='6Floorr'),
