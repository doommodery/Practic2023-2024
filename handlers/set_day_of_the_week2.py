...
async def set_day_of_the_week2_callback(callback_query: CallbackQuery):
    button_sequence.append(callback_query.data)
    await show_day_of_the_week2_keyboard(callback_query.from_user.id, callback_query.message.message_id)


async def show_day_of_the_week2_keyboard(user_id, message_id=None):
